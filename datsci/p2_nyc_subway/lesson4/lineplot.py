...
def lineplot(hr_year_csv):
    ...
    gg = ggplot(hr_year_csv, aes('yearID', 'HR')) + geom_point(color='red') + geom_line(color='red') + ggtitle('Total HRs by Year') + xlab('Year') + ylab('HR')
    return gg

if __name__ == '__main__':
    data = pandas.read_csv('../data/hr_year.csv')
    lineplot(data)
